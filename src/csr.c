...
YanStatus yan_cpu_read_csr(const YanCpu *cpu, uint32_t address, uint32_t *value)
{
    ...
    case 0x304: *value = cpu->csr.mie & YAN_MIE_MASK; break;
    ...
    case 0x344: *value = cpu->csr.mip & YAN_MIE_MASK; break;
    case 0x301: case 0x310:
...
YanStatus yan_cpu_write_csr(YanCpu *cpu, uint32_t address, uint32_t value)
{
    ...
    case 0x304: cpu->csr.mie = value & YAN_MIE_MASK; break;
    ...
    /* mip bits are driven by the devices, so a Guest write is ignored. */
    case 0x344: break;
    case 0x301: case 0x310: break;
    default: return YAN_UNSUPPORTED_INSTRUCTION;
    }
    return YAN_OK;
}
