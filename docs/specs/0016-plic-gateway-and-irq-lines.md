...
> 状态：**Spec Lock**（2026-09-20 项目所有者审核通过）。本规格修订 [0012](0012-machine-interrupts.md) 中 PLIC 网关相关的描述，并取代其中的"简化"约定与 `yan_plic_raise` 接口；0012 已加入指向本规格的更新说明。实现中如需变更接口、数据结构或行为，走 INTENTION / SPEC / IMPLE 审核，不得直接修改本文件。
